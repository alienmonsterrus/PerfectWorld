...
public class BlockRegister {
	...
	public final static Block ANIME_TELEPORT_BLOCK = new AnimeTeleportBlock("anime_teleport_block");
	public final static Block TEST_BLOCK = new TestBlock("test_block");
